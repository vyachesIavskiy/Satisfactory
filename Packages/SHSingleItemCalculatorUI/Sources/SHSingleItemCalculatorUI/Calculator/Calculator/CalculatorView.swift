...
struct CalculatorView: View {
    ...
    @MainActor @ViewBuilder
    private func adjustItemView(viewModel: ItemAdjustmentViewModel) -> some View {
        ItemAdjustmentView(viewModel: viewModel)
    }
    ...
    @MainActor @ViewBuilder
    private func sheetContentView(state: CalculatorViewModel.ModalNavigationState) -> some View {
        switch state {
...
private struct _CalculatorPreview: View {
    ...
    init(itemID: String, recipeID: String) {
        ...
        if let item, let recipe {
            _viewModel = State(initialValue: CalculatorViewModel(item: item, recipe: recipe))
        }
    }
...
#Preview("Calculator View") {
    _CalculatorPreview(itemID: "part-plastic", recipeID: "recipe-alternate-recycled-plastic")
}
#endif
