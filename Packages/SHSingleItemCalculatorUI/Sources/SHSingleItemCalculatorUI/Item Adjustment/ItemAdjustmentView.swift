...
struct ItemAdjustmentView: View {
    @State
    var viewModel: ItemAdjustmentViewModel
...
private struct _ItemAdjustmentPreview: View {
    let itemID: String
    ...
    var body: some View {
        ItemAdjustmentView(
            viewModel: ItemAdjustmentViewModel(
...
#Preview("Iron Plate") {
    _ItemAdjustmentPreview(itemID: "part-iron-plate", recipeIDs: ["recipe-iron-plate"])
}

#Preview("Reinforced Iron Plate") {
    _ItemAdjustmentPreview(
...
#Preview("Plastic") {
    _ItemAdjustmentPreview(itemID: "part-plastic", recipeIDs: ["recipe-alternate-recycled-plastic"])
}

#Preview("Heavy Modular Frame") {
    _ItemAdjustmentPreview(itemID: "part-heavy-modular-frame", recipeIDs: ["recipe-heavy-modular-frame"])
}
#endif
