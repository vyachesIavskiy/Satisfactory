...
private struct _ItemPreview: View {
    let itemID: String
...
#Preview("Plastic, 1 recipe") {
    _ItemPreview(itemID: "part-plastic", recipeIDs: ["recipe-alternate-recycled-plastic"])
}

#Preview("Rubber, 2 recipes") {
    _ItemPreview(itemID: "part-rubber", recipeIDs: [
...
#Preview("Heavy Modular Frame, 3 recipes") {
    _ItemPreview(itemID: "part-heavy-modular-frame", recipeIDs: [
