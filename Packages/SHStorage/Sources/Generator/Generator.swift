...
private extension Generator {
    enum Error: Swift.Error, CustomDebugStringConvertible {
        ...
        var debugDescription: String {
            ...
            case let .cannotFindResourcesDirectory(at: providedURL): "'Storage/Data' directory is not found at '\(providedURL.path())'. Generator can create files only as a part of Storage package."
            }
        }
    }
