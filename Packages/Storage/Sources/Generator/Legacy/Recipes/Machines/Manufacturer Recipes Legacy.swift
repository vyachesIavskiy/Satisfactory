...
extension Legacy.Recipes {
    // Standard Parts
    static let heavyModularFrameRecipe = RecipeLegacy(
    ...
    static let heavyModularFrameRecipe1 = RecipeLegacy(
    ...
    static let heavyModularFrameRecipe2 = RecipeLegacy(
    ...
    // Industrial Parts
    static let turboMotorRecipe = RecipeLegacy(
        id: "turbo-motor",
        name: "Turbo Motor",
        input: [
    ...
    static let turboMotorRecipe1 = RecipeLegacy(
    ...
    static let turboMotorRecipe2 = RecipeLegacy(
    ...
    static let motorRecipe2 = RecipeLegacy(
    ...
    static let batteryRecipe1 = RecipeLegacy(
    ...
    // Electronics
    static let highSpeedConnectorRecipe = RecipeLegacy(
    ...
    static let highSpeedConnectorRecipe1 = RecipeLegacy(
    ...
    // Communications
    static let computerRecipe = RecipeLegacy(
        id: "computer",
        name: "Computer",
        input: [
    ...
    static let computerRecipe2 = RecipeLegacy(
    ...
    static let crystalOscillatorRecipe = RecipeLegacy(
    ...
    static let crystalOscillatorRecipe1 = RecipeLegacy(
    ...
    static let supercomputerRecipe = RecipeLegacy(
        id: "supercomputer",
        name: "Supercomputer",
        input: [
    ...
    static let supercomputerRecipe1 = RecipeLegacy(
    ...
    static let radioControlUnitRecipe = RecipeLegacy(
    ...
    static let radioControlUnitRecipe1 = RecipeLegacy(
    ...
    static let radioControlUnitRecipe2 = RecipeLegacy(
    ...
    // Nuclear
    static let uraniumFuelRodRecipe = RecipeLegacy(
        id: "uranium-fuel-rod",
    ...
    static let uraniumFuelRodRecipe1 = RecipeLegacy(
    ...
    static let encasedUraniumCellRecipe1 = RecipeLegacy(
    ...
    static let plutoniumFuelRodRecipe = RecipeLegacy(
    ...
    // Consumed
    static let gasFilterRecipe = RecipeLegacy(
        id: "gas-filter",
        name: "Gas Filter",
        input: [
    ...
    static let iodineInfusedFilterRecipe = RecipeLegacy(
    ...
    static let explosiveRebarRecipe = RecipeLegacy(
        id: "explosive-rebar",
    ...
    static let turboRifleAmmoRecipe = RecipeLegacy(
    ...
    static let nukeNobeliskRecipe = RecipeLegacy(
        id: "nuke-nobelisk",
        name: "Nuke Nobelisk",
        input: [
    ...
    // Space Elevator
    static let modularEngineRecipe = RecipeLegacy(
        id: "modular-engine",
        name: "Modular Engine",
        input: [
    ...
    static let adaptiveControlUnitRecipe = RecipeLegacy(
    ...
    static let magneticFieldGeneratorRecipe = RecipeLegacy(
    ...
    static let thermalPropulsionRocketRecipe = RecipeLegacy(
    ...
    static let smartPlatingRecipe1 = RecipeLegacy(
    ...
    static let versatileFrameworkRecipe1 = RecipeLegacy(
    ...
    static let automatedWiringRecipe1 = RecipeLegacy(
    ...
    // Hands
    static let beaconRecipe = RecipeLegacy(
        id: "beacon",
        name: "Beacon",
        input: [
    ...
    static let beaconRecipe1 = RecipeLegacy(
    ...
    static let portableMinerRecipe1 = RecipeLegacy(
