...
extension Legacy.Recipes {
    // Ingots
    static let ironIngotRecipe2 = RecipeLegacy(
    ...
    static let copperIngotRecipe2 = RecipeLegacy(
    ...
    static let cateriumIngotRecipe1 = RecipeLegacy(
    ...
    // Minerals
    static let concreteRecipe3 = RecipeLegacy(
    ...
    static let quartzCrystalRecipe1 = RecipeLegacy(
    ...
    // Biomass
    static let fabricRecipe1 = RecipeLegacy(
    ...
    // Standard Parts
    static let copperSheetRecipe1 = RecipeLegacy(
    ...
    // Electronics
    static let cableRecipe3 = RecipeLegacy(
    ...
    // Advanced Refinement
    static let aluminumScrapRecipe = RecipeLegacy(
        id: "aluminum-scrap",
        name: "Aluminum Scrap",
        input: [
    ...
    static let aluminumScrapRecipe1 = RecipeLegacy(
    ...
    static let aluminaSolutionRecipe = RecipeLegacy(
        id: "alumina-solution",
    ...
    static let aluminaSolutionRecipe1 = RecipeLegacy(
    ...
    static let sulfuricAcidRecipe = RecipeLegacy(
        id: "sulfuric-acid",
        name: "Sulfuric Acid",
        input: [
    ...
    // Oil Products
    static let plasticRecipe = RecipeLegacy(
        id: "plastic",
        name: "Plastic",
        input: [
    ...
    static let residualPlasticRecipe = RecipeLegacy(
        id: "residual-plastic",
    ...
    static let plasticRecipe1 = RecipeLegacy(
    ...
    static let rubberRecipe = RecipeLegacy(
        id: "rubber",
        name: "Rubber",
        input: [
            .init(Legacy.Parts.crudeOil, amount: 3)
    ...
    static let residualRubberRecipe = RecipeLegacy(
        id: "residual-rubber",
    ...
    static let rubberRecipe1 = RecipeLegacy(
    ...
    static let petroleumCokeRecipe = RecipeLegacy(
        id: "petroleum-coke",
        name: "Petroleum Coke",
        input: [
    ...
    static let polymerResinRecipe1 = RecipeLegacy(
    ...
    static let heavyOilResidueRecipe1 = RecipeLegacy(
    ...
    // Fuel
    static let fuelRecipe = RecipeLegacy(
        id: "fuel",
        name: "Fuel",
        input: [
            .init(Legacy.Parts.crudeOil, amount: 6)
    ...
    static let residualFuelRecipe = RecipeLegacy(
        id: "residual-fuel",
        name: "Residual Fuel",
        input: [
    ...
    static let fuelRecipe1 = RecipeLegacy(
    ...
    static let liquidBiofuelRecipe = RecipeLegacy(
        id: "liquid-biofuel",
        name: "Liquid Biofuel",
        input: [
    ...
    static let turbofuelRecipe = RecipeLegacy(
        id: "turbofuel",
        name: "Turbofuel",
        input: [
            .init(Legacy.Parts.fuel, amount: 6),
    ...
    static let turbofuelRecipe1 = RecipeLegacy(
    ...
    // Cosumed
    static let smokelessPowderRecipe = RecipeLegacy(
        id: "smokeless-powder",
