...
], machine: manufacturer, duration: 30)
...
let heavyModularFrameRecipe1 = Recipe(input: [
    ...
    .init(screw, amount: 104)
        ...
        .init(heavyModularFrame, amount: 1)
], machine: manufacturer, duration: 16, isDefault: false)
...
], machine: manufacturer, duration: 64, isDefault: false)
...
], machine: manufacturer, duration: 32)
...
let motorRecipe1 = Recipe(input: [
    ...
    .init(crystalOscillator, amount: 1)
        ...
        .init(motor, amount: 6)
], machine: manufacturer, duration: 48, isDefault: false)
...
], machine: manufacturer, duration: 16)
...
], machine: manufacturer, duration: 40, isDefault: false)
...
], machine: manufacturer, duration: 24)
...
], machine: manufacturer, duration: 120)
...
let crystalOscillatorRecipe1 = Recipe(input: [
    ...
    .init(aiLimiter, amount: 1)
        ...
        .init(crystalOscillator, amount: 1)
], machine: manufacturer, duration: 32, isDefault: false)
...
], machine: manufacturer, duration: 150)
...
], machine: manufacturer, duration: 300, isDefault: false)
...
], machine: manufacturer, duration: 120, isDefault: false)
...
], machine: manufacturer, duration: 8)
...
], machine: manufacturer, duration: 20)
...
], machine: manufacturer, duration: 60)
...
let smartPlatingRecipe1 = Recipe(input: [
    ...
    .init(plastic, amount: 3)
        ...
        .init(smartPlating, amount: 2)
], machine: manufacturer, duration: 24, isDefault: false)
