...
//let satisfactory = desktop.appendingPathComponent("Satisfactory")
//
//if !fileManager.fileExists(atPath: satisfactory.path) {
//    try? fileManager.createDirectory(at: satisfactory, withIntermediateDirectories: true, attributes: nil)
//}
//
//do {
//    try encoder.encode(["parts": parts]).write(to: satisfactory.appendingPathComponent("parts.json"))
//    try encoder.encode(["equipment": equipment]).write(to: satisfactory.appendingPathComponent("equipment.json"))
//    try encoder.encode(["buildings": buildings]).write(to: satisfactory.appendingPathComponent("buildings.json"))
//    try encoder.encode(["vehicles": vehicles]).write(to: satisfactory.appendingPathComponent("vehicles.json"))
//    try encoder.encode(["recipes": Recipes]).write(to: satisfactory.appendingPathComponent("recipes.json"))
//} catch {
//    print(error)
//}
