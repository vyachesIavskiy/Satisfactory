...
struct ListRowIcon<Icon: View>: View {
    ...
    init(backgroundShape: ListRowIconBackgroundShape, @ViewBuilder icon: () -> Icon) {
        self.icon = icon()
        self.backgroundShape = backgroundShape
    }
    
    init(imageName: String, backgroundShape: ListRowIconBackgroundShape) where Icon == Image {
...
enum ListRowIconBackgroundShape {
    case angledRectangle
    case roundedRectangle
}
