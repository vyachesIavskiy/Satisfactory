...
struct NewProductionFeature: Reducer {
...
struct NewProductionView: View {
    private let store: StoreOf<NewProductionFeature>
    @ObservedObject private var viewStore: ViewStoreOf<NewProductionFeature>
    
    @State private var isShowingStatistics = false
    
    init(store: StoreOf<NewProductionFeature>) {
        self.store = store
...
//    @StateObject private static var storage: Storage = PreviewStorage()
    ...
    static var previews: some View {
        NewProductionView(store: Store(initialState: NewProductionFeature.State(appStorage: AppStorage())) {
